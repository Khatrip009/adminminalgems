// src/pages/masters/products/ProductDetailPage.tsx
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,2fr),minmax(0,1.2fr)]">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  min={0}
                  value={form.moq ?? 0}
                  onChange={(e) => handleFieldChange("moq", Number(e.target.value) || 0)}
                  className="w-full rounded-lg border border-slate-300 bg-slate-50 px-3 py-2.5 text-sm text-slate-900 focus:border-sky-500 focus:ring-sky-300 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleFieldChange("available_qty", Number(e.target.value) || 0)}
                  className="w-full rounded-lg border border-slate-300 bg-slate-50 px-3 py-2.5 text-sm text-slate-900 focus:border-sky-500 focus:ring-sky-300 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => handleFieldChange("trade_type", e.target.value)}
                  className="w-full rounded-lg border border-slate-300 bg-slate-50 px-3 py-2.5 text-sm text-slate-900 focus:border-sky-500 focus:ring-sky-300 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100"
                >
          ...
          <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setAssetSortOrder(Number(e.target.value) || 0)}
            ...
            <div className="mt-3 text-[11px] text-slate-500 dark:text-slate-400">
              Tip: Upload one <strong>hero</strong> image as primary, and additional angles or 3D models for richer product detail pages.
            </div>
          </div>
        </div>
